...
<div class="contact-form">
        <div class="container">
            ...
            <h1 class="text-uppercase">{{$schedule->title}}</h1>
            ...
            <div class="card">
                ...
                @endif
                <div class="show-schedule-text"><p>{{$schedule->description}}<p>

                    <small>Zakazan termin: <b> {{$schedule->start}} - {{$schedule->end}}</b></small>
                </div>
            </div>
