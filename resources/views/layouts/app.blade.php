        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-4 mb-lg-0" id="navbar-admin">
                        <li class="nav-item">
                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" id="navbarDropDown"
                                    ...
                                    <a class="dropdown-item" style="padding:10px;" href="/dashboard">Dashboard</a>
                                    <a class="dropdown-item" style="padding:10px;" href="{{ route('logout') }}" onclick="event.preventDefault();
